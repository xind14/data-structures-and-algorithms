...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let sortHeight = (a,b)=> parseInt(b.height)-parseInt(a.height);
  starWarsArr.sort(sortHeight);
  return starWarsArr;
};
...
//used chat gpt did not know what to use .indexof for 
